...
"""]
    ...
    ## really this should be calculated earlier
...
def install_distutils(home_dir):
    ...
    ## maybe this prefix setting should only be put in place if
    ## there's a local distutils.cfg with a prefix setting?
    home_dir = os.path.abspath(home_dir)
    ## this is breaking things, removing for now:
